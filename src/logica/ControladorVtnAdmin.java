...
public class ControladorVtnAdmin implements Initializable {
	...
	public void escogerArchivo() {
		...
		fc.getExtensionFilters().addAll(           
                new FileChooser.ExtensionFilter("select your media(*.mp4)", "*.mp4"),
	...
	public void guardar(ActionEvent event) {
		//ContadorBoton     agregarusuario=1, agregarcontenido=2, eliminarcontenido=3 , eliminarusuario=4, mostrar=5
		...
		if(contadorBoton==1) {
			...
			if(cajaArchivo.getText().length()>0 && tituloPel.getText().length()>0 && cajaImagen.getText().length()>0){
	            //FileWriter fw;
	            try {
	            	FileWriter fw;
	                ...
	                fw.write("\n"+ contenido + " " + "/recursos/" + nombreImagen + " " + "accion"+ " " + "/recursos/" + direccion);
	                fw.close();
			...
			var destinoArchivo=new File("src/recursos/" + direccion);
			var destinoArchivo2=new File("src/recursos/" + nombreImagen);
	        try {
